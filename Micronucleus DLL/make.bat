...
link /libpath:.\ littleWire_util.obj unManaged_USB.obj micronucleus_lib.obj Managed_USB.obj  Flasher.netmodule /dll /out:micronucleus.dll /ltcg /machine:X86 libusb.lib 
